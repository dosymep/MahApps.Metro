...
namespace pyRevitLabs.MahAppsMetro.Controls.Dialogs
{
    public static class DialogManager
    {
        ...
        private static MetroWindow CreateExternalWindow([CanBeNull] Window windowOwner = null)
        {
            ...
            {
                window.Resources.MergedDictionaries.Add(new ResourceDictionary { Source = new Uri("pack://application:,,,/pyRevitLabs.MahAppsMetro;component/Styles/Controls.xaml", UriKind.RelativeOrAbsolute) });
                window.Resources.MergedDictionaries.Add(new ResourceDictionary { Source = new Uri("pack://application:,,,/pyRevitLabs.MahAppsMetro;component/Styles/Fonts.xaml", UriKind.RelativeOrAbsolute) });
